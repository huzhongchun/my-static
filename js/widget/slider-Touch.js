    ...
    SliderObject.prototype = {
        ...
        changeCurentPosition:function(){
            ...
            if(o.index <= o.Prevlen && o.moveDirection == 'right'){
                ...
                o.wheel.style.cssText += '-webkit-transition: 0ms;-moz-transition: 0ms;-ms-transition: 0ms;position:relative;left:-' + (o.index * o.width) + 'px';
            }
        ...
        _move: function(index, flagAnimate) {
            ...
            if (flagAnimate == 1) {
                ...
                if (index == -1 || index == o.length) {
                    o.wheel.style.cssText += '-webkit-transition:' + o.animateTime + 'ms;-moz-transition:' + o.animateTime + 'ms;-ms-transition:' + o.animateTime + 'ms;position:relative;left:-' + (index * o.width - 100) + 'px';
                } else {
                    o.wheel.style.cssText += '-webkit-transition:' + o.animateTime + 'ms;-moz-transition:' + o.animateTime + 'ms;-ms-transition:' + o.animateTime + 'ms;position:relative;left:-' + index * o.width + 'px';
