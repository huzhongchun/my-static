...
(function(window,$,F){
	var countDownObject = function(options){
		...
		this.tpl = '<div class="count-down-box ">'+
						'<span class="days">00</span><span class="gap">'+this.settings.gapType.days+'</span>'+
						'<span class="hours">00</span><span class="gap">'+this.settings.gapType.hours+'</span>'+
						'<span class="minutes">00</span><span class="gap">'+this.settings.gapType.minutes+'</span>'+
						'<span class="seconds">00</span><span class="gap">'+this.settings.gapType.seconds+'</span>'+
					'</div>';
		this.range = {
			days: '00',
			hours: '00',
	...
	F.addWidget('countDownObject', countDownObject);
})(window,Zepto,F)